(function (global, factory) {
    ...
    function walkTree(element, context, visitor) {
        ...
        if (isReactElement(element)) {
            if (typeof element.type === 'function') {
                ...
                var isProvider = !!element.type._context;
                var previousContextValue = void 0;
                if (isProvider) {
                    previousContextValue = element.type._context._currentValue;
                }
                var child = void 0;
                var childContext_2 = __assign({}, context, { subContexts: context.subContexts ? new Map(Array.from(context.subContexts)) : new Map() });
                if (isProvider) {
                    childContext_2.subContexts.set(element.type, element.props.value);
                    child = element.props.children;
                }
                else {
                    var currentValue = element.type._currentValue;
                    if (childContext_2.subContexts.has(element.type.Provider)) {
                        currentValue = childContext_2.subContexts.get(element.type.Provider);
                    }
                    child = element.props.children(currentValue);
                }
                if (child) {
                    if (Array.isArray(child)) {
                        child.forEach(function (item) { return walkTree(item, childContext_2, visitor); });
                    }
                    else {
                        walkTree(child, childContext_2, visitor);
                    }
                }
                if (isProvider) {
                    element.type._context._currentValue = previousContextValue;
                }
            }
            else {
                if (visitor(element, null, context) === false) {
    ...
    var Query = (function (_super) {
        ...
        function Query(props, context) {
            ...
            _this.updateCurrentData = function () {
                ...
                if (onCompleted || onError) {
                    ...
                    var _b = _this.prepareCurrentResultData(currentResult), loading = _b.loading, error = _b.error, data = _b.data;
            ...
            _this.getQueryResult = function () {
                var currentResult = _this.queryObservable.currentResult();
                var data = _this.prepareCurrentResultData(currentResult);
        ...
        Query.prototype.prepareCurrentResultData = function (currentResult) {
        ...
        return function (WrappedComponent) {
            ...
            var GraphQL = (function (_super) {
                ...
                GraphQL.prototype.render = function () {
                    ...
                    return (React__default.createElement(Query, __assign$3({}, opts, { displayName: graphQLDisplayName, skip: shouldSkip, query: document, warnUnhandledError: true }), function (_a) {
                        ...
                        if (shouldSkip)
                            return React__default.createElement(WrappedComponent, __assign$3({}, props));
        ...
        return function (WrappedComponent) {
            ...
            var GraphQL = (function (_super) {
                ...
                GraphQL.prototype.render = function () {
                    ...
                    return (React__default.createElement(Mutation, __assign$4({}, opts, { mutation: document, ignoreResults: true }), function (mutate, _result) {
                        var _a, _b;
        ...
        return function (WrappedComponent) {
            ...
            var GraphQL = (function (_super) {
                ...
                GraphQL.prototype.render = function () {
                    ...
                    return (React__default.createElement(Subscription, __assign$5({}, opts, { displayName: graphQLDisplayName, skip: shouldSkip, subscription: document, shouldResubscribe: this.state.resubscribe }), function (_a) {
                        ...
                        return React__default.createElement(WrappedComponent, __assign$5({}, props, childProps));
                    }));
                };
                GraphQL.displayName = graphQLDisplayName;
                GraphQL.WrappedComponent = WrappedComponent;
        ...
        var WithApollo = (function (_super) {
            ...
            WithApollo.prototype.render = function () {
                ...
                return (React__default.createElement(ApolloConsumer, null, function (client) {
                    ...
                    return React__default.createElement(WrappedComponent, __assign$6({}, props));
                }));
            };
